...
*   **Environment:** PowerShell CLI, GitHub Actions, European cloud like Proton (GRDP/SecNumCloud principles)
...
*   [**`danki-impact-scoring`**](https://github.com/adeline-hub/danki-impact-scoring): an Impact scoring program for private equity and venture investments to calculate and evaluate the environmental and social impact scores of various projects.
